(defpackage barghest/tests/main
  (:use :cl
        :barghest
        :rove)
  (:import-from :barghest.request :decode-param))
...
(deftest test-decode-param-text-with-code
  (testing "Decoding param foo%3F should be \"foo?\""
    (ok (string= (decode-param "foo%3F") "foo?"))))
